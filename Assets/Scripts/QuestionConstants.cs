...
public class QuestionConstants
{
    public List<Question> maryQuestions = new List<Question>()
    {
        new Question(1, 0, 0,
            "Who are you to Olivia", new Answer(
                "I'm her best friend. We do everything together, who could do this?"), true),
        new Question(2, 1, 0,
        ...
        new Question(5, 0, 0,
            "What was the argument about?", new Answer(
                "I heard her speaking to another guys on the phone. Which made me angry because, she has a boyfriend"), true),
        new Question(6, 1, 0,
            "Who was on the phone?", new Answer(
                "Her secret lover, I belive he's an Real-Estate Agent"), true),
        new Question(6, 2, 0,
            "When did you return to the house?", new Answer(
                "I returned to the house an hour later, and saw someone running out of the house."), true),
        new Question(7, 1, 1,
        ...
        new Question(8, 11,  0,
            "Do you have any idea of who could have done this?", new Answer(
                "It must have been that person running away! If only I knew who it was! How could he just do this"), false, true)
    };
    ...
    public List<Question> jamesQuestions = new List<Question>()
    {
        new Question(1, 0, 0,
            ...
            new Question(3, 0, 0,
                "Where were you at the time of the murder of Olivia?", new Answer(
                    "I was on my way to gcollect the pizzas that we ordered beforehand.", false)),
            new Question(4, 1, 0,
            ...
            new Question(5, 0, 0,
                "How long did it take you to collect the pizzas?", new Answer(
                    "It took me around an 45 minutes to get there", false)),
            new Question(6, 1, 0,
                "What took you so long to get them?", new Answer(
                    "I drove into too much traffic which caused a big delay", false)),
            new Question(6, 2, 0,
                "Any reason why it was you that went to get them?", new Answer(
                    "Because Mary ordered them, It must have been Mary who set this up!", false)),
            new Question(7, 1, 1,
                "When did you return home with the pizzas?", new Answer(
                    "I came home 1 hour later and was too late, all the cops were there", false)),
            new Question(7, 1, 2,
        ...
        new Question(1, 0, 0,
            ...
            new Question(7, 1, 1,
                "Did olivia refuse to sell her house?", new Answer(
                    "Yes, she kept mentioning that she will keep it as a memory of her")),
            new Question(7, 1, 2,
                "Who will own the house now?", new Answer(
                    "Uh due to her unfortunate death, the house will go up for sale")),
            new Question(7, 2, 1,
                "Did you go to the house afterwards?", new Answer(
                    "No! I did not want to get involved in their drama, so I remained silent")),
            new Question(7, 2, 2,
                "Did you have a secret relationship with Olivia?", new Answer(
